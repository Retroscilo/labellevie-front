  ...
  return (
    <div className="grid md:grid-rows-1 md:grid-cols-[1fr_2px_1fr] p-12 gap-10 max-w-body mx-auto">
      <div className="relative flex flex-col gap-8 p-6">
        <div className={`font-title text-titles text-center text-lg font-medium mb-8`}>{parse(pros_title)}</div>
      ...
      <div className="relative flex flex-col gap-8 p-6">
        <div className={`font-title text-titles text-center font-medium text-lg`}>{parse(cons_title)}</div>
